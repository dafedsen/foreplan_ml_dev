...
def run_model(id_user, dbase, dbset, ex_id):
    try:
        ...
        logging_ml(id_user, id_prj, id_version, id_cust, "Holt-Winters", "RUNNING", "Model is running", "holt_winters_gpu.py : run_model", execution_id=ex_id)
        ...
        logging_ml(id_user, id_prj, id_version, id_cust, "Holt-Winters", "FINISHED", "Finished running model", "holt_winters_gpu.py : run_model",
        ...
        logging_ml(id_user, id_prj, id_version, id_cust, "Holt-Winters", "ERROR", "Error in running model", "holt_winters_gpu.py : run_model : " + str(e),
                   execution_id=ex_id)
...
def predict_model(df, st, t_forecast):
    ...
    try:
        ...
        print('ERROR in predicting holt_winters : ', e)
        pred['date'] = t_forecast['date']
        pred[level2] = 0
        pred['level1'] = level1
        pred['adj_include'] = ADJUSTMENT
    ...
    try:
        ...
        print('ERROR in evaluating holt_winters : ', e)
        rmse = 999999999
        r2 = 999999999
        bias = 999999999
        mape = 999999999
